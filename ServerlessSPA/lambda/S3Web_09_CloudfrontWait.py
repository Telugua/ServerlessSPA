...
# ==============================================================================
    ...
    parameter = ssm.get_parameter(Name='/S3Web/' + pAppName + '/CloudfrontStack', WithDecryption=True)
    cloudfrontstack = parameter['Parameter']['Value']
    print(cloudfrontstack)

    waiter.wait(StackName=cloudfrontstack)