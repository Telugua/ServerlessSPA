...
# ==============================================================================
    ...
    parameter = ssm.get_parameter(Name='/S3Web/' + pAppName + '/Route53Stack', WithDecryption=True)
    route53stack = parameter['Parameter']['Value']
    print(route53stack)

    waiter.wait(StackName=route53stack)